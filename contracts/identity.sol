...
contract idenity is p256Lib{
    ...
    bytes public keyHandle; //Contains the keyhandle generated by the uf2 protocal on signing
    ...
    constructor(uint256 _public_qx, uint _public_qy, bytes32 applicationId, bytes4 _counter, bytes memory _keyHandle) public{
